...
def calculate_remaining_time(pid):
    ...
    # 3. Machine Learning Predictions (Linear Regression)
    lin_pred = train_models(history)
    ...
    tsi = (avg_burst_time + ewma_burst_time + lin_pred) / 3  # Rata-rata dari semua metode
