...
def calculate_remaining_time(pid):
    ...
    # 4. Hitung Estimasi Burst Time dengan Mitigasi Ketidakpastian
    tsi = (avg_burst_time + ewma_burst_time) / 2  # Rata-rata dari semua metode
    tsu = max(ALPHA_RT * tsi - BETA_RT * std_dev, 0)  # Mitigasi ketidakpastian

    # 5. Hitung waktu yang sudah berjalan
